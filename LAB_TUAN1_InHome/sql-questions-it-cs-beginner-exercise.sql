...
-------N là để hiển thị tiếng việt khi truy vấn, không có N thì không ghi tiếng việt được------
...
SELECT 
    k.TenKyNang AS TenKyNang, 
    c.CapDo AS CapDo
FROM ChuyenGia_KyNang c JOIN KyNang k 
ON c.MaKyNang = k.MaKyNang;
